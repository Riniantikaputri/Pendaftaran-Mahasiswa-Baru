    ...
    <form id="form" method="post">
		<!-- paket kelas -->
            <div class="alert alert-primary">
                <strong>Paket Kelas Teknik Informatika</strong>
            </div>
			<div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="paket" id="paket" required>
                            ...
                            <option value="S1-TI Paket Kelas A " <?php echo($p->paket == 1)? 'selected':''; ?>>Paket A</option>
                            <option value="S1-TI Paket Kelas B" <?php echo($p->paket == 2)? 'selected':''; ?>>Paket B</option>
                            <option value="S1-TI Paket Kelas C" <?php echo($p->paket == 3)? 'selected':''; ?>>Paket C</option>
                            <option value="S1-TI Paket Kelas D" <?php echo($p->paket == 4)? 'selected':''; ?>>Paket D</option>
                        </select>
                    </div>
                </div>
			</div>
